<template>
    ...
    <div class="row items-center q-gutter-sm justify-between q-py-lg q-gutter-sm">
        ...
        <div class="row justify-center" style="width: 100%;">
            <q-btn unelevated rounded outline style="color: #009EFB;" padding="sm xl"  label="Mostrar todas as facilidades" no-caps size="md" :loading="false" :disable="false" @click="handleClick" />
        </div>
    </div>
    <q-separator color="grey" />
